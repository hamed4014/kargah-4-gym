...
document.getElementById("btn_new_sport_plan").onclick = function () {
    ...
    document.getElementById("new_sport_plan").style.zIndex = 2;
    document.getElementById("new_sport_plan").style.opacity = 1;
    document.getElementById("new_sport_plan").style.visibility = "visible";
    document.getElementById("new_sport_plan").style.zIndex = 2;
}

document.getElementById("exit_new_sport_plan").onclick = function () {
    document.getElementById("main_diets").style.opacity =1;
    document.getElementById("main_diets").style.filter = "none";
    document.getElementById("new_sport_plan").style.opacity = 0;
    document.getElementById("new_sport_plan").style.visibility = "hidden";
    document.getElementById("new_sport_plan").style.zIndex = 2;
}